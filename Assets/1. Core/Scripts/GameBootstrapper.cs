...
namespace Cinderwild.Core.Runtime
{
    public class GameBootstrapper : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            TileData enemySpawnTile = FindEnemyTile();
        ...
        private void SpawnFire(TileData tile)
        {
        ...
        // Spawns the player
        private void SpawnPlayer(TileData tile)
        {
        ...
        private void SpawnUnit(TileData tile)
        {
        ...
        private void SpawnEnemySpawner(TileData tile)
        {
        ...
        private void SpawnUnitSpawner(TileData tile)
        {
        ...
        TileData FindSpawnTile()
        {
            ...
            WorldData grid = world.Context.grid;
